    ...
    <DocLayout>
      <div className='px-6 py-8'>
        ...
        <div className='flex items-center gap-2 text-sm text-gray-600 mb-6'>
          ...
          <span>›</span>
          <Link href='/docs/api/overview' className='hover:text-gray-900'>
            API Reference
          </Link>
          <span>›</span>
          ...
          <div className='flex items-center gap-4 mb-4'>
            ...
            <div>
              ...
              <p className='text-lg text-gray-600 mt-2'>
                Secure authentication endpoints for managing user sessions and
                API access
              </p>
            </div>
          </div>
          ...
          <Card className='bg-blue-50/50 border-blue-200'>
            ...
            <CardContent className='space-y-4'>
              <p className='text-gray-700'>
                VPN Enterprise uses Bearer token authentication. All API
                requests must include a valid access token in the Authorization
                header.
              </p>
        ...
        <div className='mb-12'>
          ...
          <div className='grid md:grid-cols-2 gap-6'>
            ...
            <Card className='bg-linear-to-br from-blue-50 to-indigo-50 border-blue-200'>
              ...
              <CardContent>
                <p className='text-gray-600 mb-3'>
                  Include the token in the Authorization header for API
                  requests.
                </p>
                <div className='bg-gray-900 text-gray-100 p-3 rounded text-xs font-mono overflow-x-auto'>
            ...
            {authEndpoints.map((endpoint, index) => (
              ...
              >
                ...
                <CardContent className='pt-6'>
                  <Tabs
                    defaultValue={endpoint.request ? 'request' : 'response'}
                    className='w-full'
                  >
                ...
                <div className='flex items-start gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-green-700 text-sm'>
                      Store tokens securely in environment variables or secure
                      storage solutions. Never expose tokens in client-side
                      code.
                    </p>
                  </div>
                </div>
                ...
                <div className='flex items-start gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-blue-700 text-sm'>
                      Implement automatic token refresh using refresh tokens to
                      maintain session continuity without user intervention.
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                <div className='flex items-start gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-amber-700 text-sm'>
                      Always use HTTPS in production. Authentication endpoints
                      will reject HTTP requests in production environments.
                    </p>
                  </div>
                </div>
              </CardContent>
