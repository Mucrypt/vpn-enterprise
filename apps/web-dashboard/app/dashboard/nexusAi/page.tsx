      ...
      <section className='pt-12 pb-16 px-6'>
        <div className='max-w-6xl mx-auto'>
          <div className='text-center mb-8'>
            ...
            <h1 className='text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 bg-clip-text text-transparent leading-tight'>
              Build Full-Stack Apps
              <br />
              with Just a Description
            </h1>
            <p className='text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed'>
              Introducing <span className='font-semibold text-purple-600'>NexusAI</span> - your intelligent app builder. 
              Describe your idea in plain English and watch as AI generates a complete, production-ready 
              application with database, authentication, and beautiful UI.
            </p>
            
            <div className='flex items-center justify-center gap-4 mb-6'>
              <Link href='/nexusai'>
                <Button size='lg' className='text-lg px-10 py-6 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 shadow-lg hover:shadow-xl transition-all'>
                  Launch NexusAI
                  <ArrowRight className='ml-2 w-5 h-5' />
                </Button>
              </Link>
              <Button size='lg' variant='outline' className='text-lg px-10 py-6 border-2 hover:border-purple-600 hover:text-purple-600 transition-all'>
                Watch Demo
              </Button>
            </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-4 gap-4 mt-12'>
            {[
              ...
              <Card key={index} className='bg-white/80 backdrop-blur border-gray-200 hover:shadow-lg transition-shadow'>
        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            {features.map((feature, index) => (
              <Card key={index} className='hover:shadow-lg transition-shadow border-gray-200 bg-white'>
                <CardHeader>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <p className='text-lg text-gray-600 mb-8 leading-relaxed'>
                NexusAI combines the power of large language models with enterprise-grade 
                infrastructure to deliver complete applications that are ready for production use.
              </p>
              <Link href='/nexusai'>
            ...
            <Card className='bg-white border-gray-200 shadow-lg'>
              <CardHeader>
                ...
                <CardDescription>Comprehensive features for modern app development</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <Card className='bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 border-0 shadow-2xl'>
            <CardContent className='pt-12 pb-12 text-center'>
              ...
              <p className='text-xl text-white/90 mb-8 max-w-2xl mx-auto'>
                Join thousands of developers who are building faster with NexusAI. 
                Start your first project today and see the magic happen.
              </p>
              <div className='flex items-center justify-center gap-4'>
                <Link href='/nexusai'>
                  <Button size='lg' variant='secondary' className='text-lg px-10 py-6 bg-white text-purple-600 hover:bg-gray-100 shadow-lg'>
                    Launch NexusAI Now
