  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-white via-green-50 to-yellow-50">
        ...
        <div className="absolute inset-0 bg-gradient-to-bl from-green-100/30 via-transparent to-amber-100/30"></div>
        
        {/* Bright animated orbs */}
        <div className="absolute top-20 left-20 w-96 h-96 bg-gradient-to-r from-emerald-300/40 to-green-300/40 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-40 right-32 w-80 h-80 bg-gradient-to-r from-yellow-300/35 to-amber-300/35 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-32 left-32 w-72 h-72 bg-gradient-to-r from-lime-300/30 to-emerald-300/30 rounded-full blur-3xl animate-pulse" style={{animationDelay: '4s'}}></div>
        <div className="absolute bottom-20 right-20 w-64 h-64 bg-gradient-to-r from-gold/25 to-yellow-400/25 rounded-full blur-3xl animate-pulse" style={{animationDelay: '6s'}}></div>
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-yellow-300/[0.15] to-transparent transform -skew-x-12 animate-shimmer"></div>
      </div>
      ...
      <div ref={floatingIconsRef} className="fixed inset-0 pointer-events-none">
        {[
          { icon: Shield, color: "text-blue-400", size: "w-8 h-8", left: "10%", top: "20%" },
          { icon: Lock, color: "text-green-400", size: "w-6 h-6", left: "85%", top: "30%" },
          { icon: Database, color: "text-purple-400", size: "w-10 h-10", left: "15%", top: "70%" },
          { icon: Server, color: "text-cyan-400", size: "w-8 h-8", left: "75%", top: "60%" },
          { icon: Globe, color: "text-yellow-400", size: "w-7 h-7", left: "50%", top: "15%" },
          { icon: Key, color: "text-pink-400", size: "w-5 h-5", left: "25%", top: "40%" },
          { icon: ShieldCheck, color: "text-emerald-400", size: "w-9 h-9", left: "90%", top: "80%" },
          { icon: EyeOff, color: "text-red-400", size: "w-6 h-6", left: "40%", top: "85%" },
        ].map((item, index) => (
          <div
            key={index}
      ...
      <div ref={vpnVisualizationRef} className="fixed inset-0 pointer-events-none">
        <svg className="absolute inset-0 w-full h-full opacity-20">
          {/* VPN Connections */}
          <path className="vpn-connection" d="M100,200 Q400,100 700,300" stroke="url(#vpn-gradient1)" strokeWidth="1" fill="none" />
          <path className="vpn-connection" d="M150,400 Q450,300 750,500" stroke="url(#vpn-gradient2)" strokeWidth="1" fill="none" />
          <path className="vpn-connection" d="M200,600 Q500,500 800,700" stroke="url(#vpn-gradient3)" strokeWidth="1" fill="none" />
          
          <defs>
            <linearGradient id="vpn-gradient1" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#3b82f6" stopOpacity="0" />
              <stop offset="50%" stopColor="#3b82f6" stopOpacity="0.3" />
              <stop offset="100%" stopColor="#3b82f6" stopOpacity="0" />
            </linearGradient>
            <linearGradient id="vpn-gradient2" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#8b5cf6" stopOpacity="0" />
              <stop offset="50%" stopColor="#8b5cf6" stopOpacity="0.3" />
              <stop offset="100%" stopColor="#8b5cf6" stopOpacity="0" />
            </linearGradient>
            <linearGradient id="vpn-gradient3" x1="0%" y1="0%" x2="100%" y2="0%">
        ...
        {[
          ...
          >
            <div className={`absolute w-4 h-4 rounded-full ${node.color} opacity-30 animate-ping`}></div>
            <div className={`relative w-3 h-3 rounded-full ${node.color}`}></div>
          </div>
        ))}
      </div>
      ...
      <nav className="fixed top-0 w-full z-50 backdrop-blur-lg bg-white/60 border-b border-emerald-200/50 shadow-lg">
        <div className="container mx-auto px-4 md:px-6 py-3 md:py-4 flex justify-between items-center">
          <div className="flex items-center gap-2 md:gap-4">
            <div 
              ref={logoRef}
              className="relative group security-seal"
            >
              <div className="absolute -inset-2 bg-gradient-to-r from-emerald-400/40 via-yellow-400/40 to-green-400/40 rounded-2xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
              <div className="relative p-2 md:p-3 bg-gradient-to-br from-emerald-50/90 to-green-50/90 rounded-xl border border-emerald-300/30 group-hover:border-emerald-400/50 transition-all duration-500 backdrop-blur-sm shadow-lg">
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-200/20 to-yellow-200/20 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs font-medium bg-gradient-to-r from-emerald-600 to-yellow-600 bg-clip-text text-transparent hidden sm:block">
          ...
          <Button
            className="group relative overflow-hidden bg-gradient-to-r from-emerald-600 via-green-600 to-yellow-600 hover:from-emerald-500 hover:via-green-500 hover:to-yellow-500 shadow-2xl shadow-emerald-500/25 border border-emerald-300/30 backdrop-blur-sm"
            onClick={handleDashboardClick}
            disabled={dashboardButtonDisabled}
            data-magnetic
          >
            <div className="absolute inset-0 bg-gradient-to-r from-white/30 via-yellow-100/20 to-white/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <div className="absolute -inset-1 bg-gradient-to-r from-emerald-400 via-green-400 to-yellow-400 rounded-lg blur opacity-0 group-hover:opacity-40 transition-opacity duration-500"></div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-6xl mx-auto">
            ...
            >
              ...
              <span className="text-emerald-600 font-semibold"> secure VPN</span>, 
              <span className="text-green-600 font-semibold"> reliable databases</span>, and 
              <span className="text-yellow-600 font-semibold"> scalable hosting</span>.
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              {[
                { icon: ShieldCheck, text: "Military-Grade Security", color: "from-emerald-500 to-green-600" },
                { icon: Zap, text: "High Performance", color: "from-yellow-500 to-amber-600" },
                { icon: GlobeLock, text: "Global Network", color: "from-green-500 to-emerald-600" },
                { icon: DatabaseZap, text: "Managed Databases", color: "from-lime-500 to-green-600" },
                { icon: ServerCog, text: "Auto-Scaling Hosting", color: "from-amber-500 to-yellow-600" }
              ].map((item, index) => (
                <div 
                  key={index}
            ...
            {/* CTA Buttons */}
            <div ref={ctaRef} className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center">
              <Button
                size="lg"
                className="group text-base sm:text-lg px-8 sm:px-12 py-4 sm:py-6 bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 shadow-xl hover:shadow-emerald-500/25 transition-all duration-300 w-full sm:w-auto"
                onClick={handleDashboardClick}
                disabled={dashboardButtonDisabled}
                data-magnetic
              >
            ...
            <div className="mt-12 md:mt-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {[
                { number: "10,000+", label: "VPN Connections", icon: UsersRound, color: "text-emerald-600" },
                { number: "99.99%", label: "Uptime SLA", icon: TrendingUp, color: "text-green-600" },
                { number: "256-bit", label: "Encryption", icon: LockKeyhole, color: "text-yellow-600" },
                { number: "<20ms", label: "Avg Latency", icon: Zap, color: "text-amber-600" }
              ].map((stat, index) => (
                <div 
                  key={index}
                ...
                >
                  ...
                  <div className="metric-number text-3xl font-bold text-gray-800 mb-1">{stat.number}</div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything your business needs in one platform. Secure, reliable, and scalable.
            </p>
          </div>
          ...
          <div className="mb-20">
            <div className="flex items-center gap-4 mb-8">
              <div className="p-3 bg-gradient-to-br from-emerald-400/30 to-green-500/30 rounded-xl border border-emerald-400/40 shadow-lg">
                <Shield className="h-8 w-8 text-emerald-700" />
              </div>
              <div>
                <h3 className="text-3xl font-bold text-gray-800">Enterprise VPN</h3>
                <p className="text-gray-600">Secure remote access for your entire organization</p>
              </div>
            </div>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: LockKeyhole, title: "256-bit Encryption", desc: "Military-grade security for all connections" },
                { icon: GlobeLock, title: "Global Servers", desc: "100+ locations worldwide" },
                { icon: UsersRound, title: "Team Management", desc: "Centralized user & access control" },
                { icon: Activity, title: "Real-time Monitoring", desc: "Live connection analytics & alerts" }
              ].map((feature, index) => (
                <Card key={index} className="service-card bg-white/60 border-emerald-200 backdrop-blur-sm shadow-lg">
          ...
          <div className="mb-20">
            <div className="flex items-center gap-4 mb-8">
              <div className="p-3 bg-gradient-to-br from-green-400/30 to-emerald-500/30 rounded-xl border border-green-400/40 shadow-lg">
                <Database className="h-8 w-8 text-green-700" />
              </div>
              <div>
                <h3 className="text-3xl font-bold text-gray-800">Managed Databases</h3>
                <p className="text-gray-600">Production-ready databases with automated management</p>
              </div>
            </div>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: DatabaseZap, title: "Auto-scaling", desc: "Automatically scales with your workload" },
                { icon: ShieldCheck, title: "Daily Backups", desc: "Automatic backups & point-in-time recovery" },
                { icon: Zap, title: "High Performance", desc: "SSD storage & optimized queries" },
                { icon: Settings, title: "Managed Updates", desc: "Automatic security & performance updates" }
              ].map((feature, index) => (
                <Card key={index} className="service-card bg-white/60 border-green-200 backdrop-blur-sm shadow-lg">
                  <CardHeader className="p-6">
          ...
          <div className="mb-20">
            <div className="flex items-center gap-4 mb-8">
              <div className="p-3 bg-gradient-to-br from-yellow-400/30 to-amber-500/30 rounded-xl border border-yellow-400/40 shadow-lg">
                <Server className="h-8 w-8 text-yellow-700" />
              </div>
              <div>
                <h3 className="text-3xl font-bold text-gray-800">Cloud Hosting</h3>
                <p className="text-gray-600">Scalable web hosting with enterprise reliability</p>
              </div>
            </div>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: ServerCog, title: "Auto-scaling", desc: "Scale resources based on traffic" },
                { icon: Globe, title: "Global CDN", desc: "Content delivery network included" },
                { icon: Shield, title: "DDoS Protection", desc: "Enterprise-grade attack mitigation" },
                { icon: Terminal, title: "One-click Deploy", desc: "Deploy from Git in seconds" }
              ].map((feature, index) => (
                <Card key={index} className="service-card bg-white/60 border-yellow-200 backdrop-blur-sm shadow-lg">
                  <CardHeader className="p-6">
      ...
      <div className="py-24 bg-gradient-to-b from-green-50/50 to-yellow-50/50">
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="service-card group">
              <Card className="relative bg-white/70 backdrop-blur-sm border border-emerald-200 group-hover:border-emerald-400/70 transition-all duration-500 h-full shadow-lg">
                <CardHeader className="p-8">
                  <CardTitle className="text-gray-800 text-2xl font-bold mb-2">Starter</CardTitle>
                  <div className="text-3xl font-bold text-emerald-600 mb-6">
                    $9<span className="text-lg text-gray-600">/month</span>
                  </div>
                  <p className="text-gray-600 mb-6">Perfect for small teams and projects</p>
            ...
            <div className="service-card group lg:scale-105 lg:-translate-y-2 z-10" data-magnetic>
              <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500 to-green-500 rounded-2xl blur opacity-30 group-hover:opacity-50 transition-opacity duration-500"></div>
              <Card className="relative bg-white/80 backdrop-blur-sm border-2 border-emerald-500 group-hover:border-green-500 transition-all duration-500 h-full shadow-xl">
                ...
                <CardHeader className="p-8">
                  <CardTitle className="text-gray-800 text-2xl font-bold mb-2">Professional</CardTitle>
                  <div className="text-4xl font-bold bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent mb-6">
                  ...
                  <ul className="space-y-3 text-gray-700 text-sm">
                    ...
                    <li className="flex items-center gap-2">
                      <Sparkles className="h-4 w-4 text-green-600" />
                      <span className="font-semibold">10GB database storage</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <Sparkles className="h-4 w-4 text-green-600" />
                      <span className="font-semibold">100GB object storage</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <Sparkles className="h-4 w-4 text-green-600" />
                      <span className="font-semibold">Advanced hosting features</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <Sparkles className="h-4 w-4 text-green-600" />
            ...
            <div className="service-card group">
              <Card className="relative bg-white/70 backdrop-blur-sm border border-yellow-200 group-hover:border-yellow-400/70 transition-all duration-500 h-full shadow-lg">
                <CardHeader className="p-8">
                  <CardTitle className="text-gray-800 text-2xl font-bold mb-2">Enterprise</CardTitle>
          ...
          <div className="mt-16 relative h-32 overflow-hidden rounded-xl border border-emerald-300 bg-white/30 shadow-lg">
            ...
            <div className="absolute inset-0">
              {[...Array(12)].map((_, i) => (
                <div
                  key={i}
                  className="data-packet absolute w-3 h-2 bg-gradient-to-r from-emerald-500 to-green-500 rounded"
                  style={{
                    left: `${i * 8}%`,
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <span className="text-gray-700 text-sm">Encrypted Data Flow</span>
                  <Upload className="h-4 w-4 text-green-600" />
                </div>
                <p className="text-gray-600 text-sm">All plans include end-to-end encryption</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={timelineContainerRef} className="py-24">
        <div className="container mx-auto px-6">
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-0.5 bg-gradient-to-b from-emerald-500 via-green-500 to-transparent"></div>
            
            {[
              {
                year: "Startups",
                title: "Launch Quickly",
                description: "Get your secure infrastructure running in minutes, not weeks",
                icon: Rocket,
                side: "left",
              ...
              },
              {
                ...
                description: "Automatically scale VPN, databases, and hosting as you grow",
                icon: TrendingUp,
                side: "right",
              ...
              },
              {
                ...
                description: "Military-grade encryption and compliance for large organizations",
                icon: ShieldCheck,
                side: "left",
              ...
              >
                <div className={`absolute top-0 ${item.side === 'left' ? 'right-0' : 'left-0'} transform ${item.side === 'left' ? 'translate-x-1/2' : '-translate-x-1/2'}`}>
                ...
                <div className={`bg-white/70 backdrop-blur-sm border border-emerald-200 rounded-xl p-6 shadow-lg ${item.side === 'left' ? 'mr-8' : 'ml-8'}`}>
                  <div className="text-emerald-600 font-bold text-sm mb-1">{item.year}</div>
                  <h3 className="text-gray-800 text-xl font-bold mb-2">{item.title}</h3>
                  <p className="text-gray-600 mb-3">{item.description}</p>
                  <div className="text-green-600 text-sm font-medium">{item.stats}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* 🏢 TECH STACK */}
      <div className="py-24 bg-gradient-to-b from-yellow-50/50 to-green-50/50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { 
                icon: Shield, 
                title: "Security Core", 
                items: ["WireGuard Protocol", "256-bit Encryption", "Zero Trust Network", "Audit Logging"],
                color: "from-blue-500 to-cyan-500"
              },
              { 
                icon: Database, 
                title: "Database Engine", 
                items: ["PostgreSQL", "Automatic Backups", "Read Replicas", "Query Optimization"],
                color: "from-purple-500 to-violet-500"
              },
              { 
                icon: Server, 
                title: "Hosting Platform", 
                items: ["Docker Containers", "Global CDN", "Auto-scaling", "Load Balancing"],
                color: "from-cyan-500 to-blue-500"
              },
              { 
                icon: Settings, 
                title: "Management", 
                items: ["Centralized Dashboard", "Team Collaboration", "API Access", "Monitoring"],
                color: "from-green-500 to-emerald-500"
              }
            ].map((stack, index) => (
              <Card key={index} className="bg-white/70 border-emerald-200 backdrop-blur-sm shadow-lg">
                <CardHeader className="p-6">
                  <div className={`p-3 bg-gradient-to-br ${stack.color} bg-opacity-20 rounded-xl w-fit mb-4`}>
                    <stack.icon className="h-8 w-8 text-gray-700" />
                  </div>
                  <CardTitle className="text-gray-800 text-lg mb-4">{stack.title}</CardTitle>
      ...
      <div className="py-24">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center bg-gradient-to-br from-white/70 to-green-50/70 backdrop-blur-sm rounded-2xl p-12 border border-emerald-200 shadow-xl">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
                Ready to Secure Your Infrastructure?
              </h2>
              <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
                Join thousands of businesses that trust VPN Enterprise for their critical infrastructure needs.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <Button
                  size="lg"
                  className="text-lg px-12 py-6 bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 shadow-xl hover:shadow-emerald-500/25"
                  onClick={handleDashboardClick}
                  disabled={dashboardButtonDisabled}
                >
                  {dashboardButtonDisabled ? (
      ...
      <div ref={brandsRef} className="py-16 bg-gradient-to-b from-white via-green-50/30 to-yellow-50/30">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 md:gap-8 items-center justify-items-center max-w-6xl mx-auto">
            ...
            <div className="brand-logo group">
              <div className="relative p-8 bg-white/80 rounded-2xl border border-green-100 shadow-lg hover:shadow-2xl transition-all duration-500 backdrop-blur-sm group-hover:border-green-300/50">
                <div className="absolute inset-0 bg-gradient-to-br from-green-50/50 to-yellow-50/50 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative w-20 h-20 flex items-center justify-center">
                  <svg viewBox="0 0 200 60" className="w-16 h-8">
                    <path fill="#ff9900" d="M20.1 35.4c-6.3 4.7-15.4 7.2-23.2 7.2-11 0-20.9-4.1-28.4-10.9-.6-.5-.1-1.3.7-.9 8.8 5.1 19.6 8.2 30.8 8.2 7.5 0 15.8-1.6 23.4-4.8 1.1-.5 2.1.8.9 1.6z"/>
                    <path fill="#ff9900" d="M22.6 32.7c-.8-1-5.3-.5-7.3-.2-.6.1-.7-.4-.2-.8 3.6-2.5 9.4-1.8 10.1-.9.7.8-.2 6.7-3.5 9.5-.5.4-1-.2-.8-.7.8-1.9 2.5-6.1 1.7-6.9z"/>
                    <text x="50" y="25" fill="#232F3E" fontSize="18" fontFamily="Arial" fontWeight="bold">amazon</text>
                  </svg>
                </div>
              </div>
            </div>
            ...
            <div className="brand-logo group">
              <div className="relative p-8 bg-white/80 rounded-2xl border border-yellow-100 shadow-lg hover:shadow-2xl transition-all duration-500 backdrop-blur-sm group-hover:border-yellow-300/50">
                <div className="absolute inset-0 bg-gradient-to-br from-yellow-50/50 to-amber-50/50 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative w-20 h-20 flex items-center justify-center">
            ...
            <div className="brand-logo group">
              <div className="relative p-8 bg-white/80 rounded-2xl border border-red-100 shadow-lg hover:shadow-2xl transition-all duration-500 backdrop-blur-sm group-hover:border-red-300/50">
                <div className="absolute inset-0 bg-gradient-to-br from-red-50/50 to-rose-50/50 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative w-20 h-20 flex items-center justify-center">
          ...
          <div className="flex items-center justify-center mt-12">
            <div className="flex-1 h-px bg-gradient-to-r from-transparent via-emerald-200 to-transparent max-w-md"></div>
            <div className="px-6">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid md:grid-cols-5 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <span className="text-xl font-bold text-gray-800">VPN Enterprise</span>
                  <p className="text-gray-600 text-sm">Enterprise Infrastructure Platform</p>
                </div>
              </div>
          ...
          <div className="border-t border-emerald-200 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-center md:text-left">
              VPN Enterprise Platform © 2025 | Built with Next.js, WireGuard & Enterprise Security
            </p>
            <div className="flex gap-6 mt-4 md:mt-0">
              <Link href="#" className="text-gray-600 hover:text-emerald-600 transition-colors">Privacy</Link>
              <Link href="#" className="text-gray-600 hover:text-emerald-600 transition-colors">Terms</Link>
              <Link href="#" className="text-gray-600 hover:text-emerald-600 transition-colors">Security</Link>
            </div>
          </div>
        </div>
      </footer>
