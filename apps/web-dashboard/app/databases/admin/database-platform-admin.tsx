...
export function DatabasePlatformAdmin({ initialTenants }: DatabasePlatformAdminProps) {
  ...
  const stats = useMemo(() => {
    ...
    const regionCounts = tenants.reduce((acc, t) => {
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-800 text-left">
                    <th className="pb-3 text-sm font-medium text-gray-400">Project</th>
                    <th className="pb-3 text-sm font-medium text-gray-400">Region</th>
                    <th className="pb-3 text-sm font-medium text-gray-400">Plan</th>
                    <th className="pb-3 text-sm font-medium text-gray-400">Database</th>
                  ...
                  {filteredTenants.length === 0 ? (
                    ...
                    filteredTenants.map((tenant) => (
                      ...
                      >
                        ...
                        <td className="py-4">
                          <Badge
                            variant={tenant.plan_type === 'premium' ? 'default' : 'secondary'}
                            className={
