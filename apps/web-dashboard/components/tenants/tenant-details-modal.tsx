...
export function TenantDetailsModal({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.message || `Failed to update tenant: ${response.status}`,
        )
      }
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        const errorData = await response.json().catch(() => ({}))
        throw new Error(
          errorData.message || `Failed to delete tenant: ${response.status}`,
        )
      }
  ...
  const userUsagePercent = tenant.max_users
    ? (tenant.current_users / tenant.max_users) * 100
    : 0
  const storageUsagePercent = tenant.max_storage_gb
    ? (tenant.storage_used_gb / tenant.max_storage_gb) * 100
    : 0
            ...
            <div className='flex items-center gap-4'>
              ...
              <div>
                ...
                <DialogDescription className='text-gray-300 text-base mt-1'>
                  {tenant.subdomain}.vpn-enterprise.com • {tenant.plan_type}{' '}
                  plan
                </DialogDescription>
              </div>
            </div>
              ...
              <Badge
                className={
                  tenant.status === 'active'
                    ? 'bg-green-600/20 text-green-400 border-green-600/30 px-3 py-1'
                    : tenant.status === 'suspended'
                      ? 'bg-red-600/20 text-red-400 border-red-600/30 px-3 py-1'
              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
                ...
                <Card className='bg-[#252525] border-gray-700'>
                  <CardHeader className='pb-4'>
                    ...
                    <CardDescription className='text-gray-400'>
                      Current user allocation and limits
                    </CardDescription>
                  </CardHeader>
                  <CardContent className='space-y-6'>
                    <div className='space-y-4'>
                      <div className='flex justify-between items-center'>
                        ...
                        <span className='text-white font-bold text-lg'>
                          {tenant.current_users || 0} / {tenant.max_users || 0}
                        </span>
                      </div>
                      <div className='space-y-2'>
                        ...
                        <div className='flex justify-between text-sm'>
                          ...
                          <span className='text-gray-400'>
                            {tenant.max_users - (tenant.current_users || 0)}{' '}
                            remaining
                          </span>
                        </div>
                      </div>
                ...
                <Card className='bg-[#252525] border-gray-700'>
                  <CardHeader className='pb-4'>
                    ...
                    <CardDescription className='text-gray-400'>
                      Current storage allocation and limits
                    </CardDescription>
                  </CardHeader>
                  <CardContent className='space-y-6'>
                    <div className='space-y-4'>
                    ...
                    <div className='flex items-center gap-4 p-4 bg-[#1e1e1e] border border-gray-600 rounded-lg'>
                      ...
                      <div>
                        ...
                        <div className='text-gray-300 text-sm'>
                          {new Date(
                            tenant.last_activity || tenant.created_at,
            ...
            <TabsContent value='databases' className='space-y-8 mt-6 px-1'>
              <Card className='bg-[#252525] border-gray-700'>
                <CardHeader className='pb-4'>
                  ...
                  <CardDescription className='text-gray-400'>
                    Manage databases and access controls for this tenant
                  </CardDescription>
                </CardHeader>
                <CardContent className='space-y-6'>
                  <div className='flex items-center justify-between p-6 bg-[#1e1e1e] border border-gray-600 rounded-xl'>
                    <div className='flex items-center gap-4'>
                      ...
                      <div>
                        ...
                        <div className='text-gray-300'>
                          Open the database management interface for this tenant
                        </div>
                      </div>
                    </div>
                    <Button
                    ...
                    >
                      <a
                        href={`/databases?tenantId=${tenant.id}`}
                        target='_blank'
                  ...
                  <div className='text-sm text-gray-600 bg-gray-50 p-3 rounded-lg'>
                    This tenant has access to {tenant.database_count || 0}{' '}
                    database{tenant.database_count !== 1 ? 's' : ''}. Use the
                    database management interface to create, edit, and manage
            ...
            <TabsContent value='settings' className='space-y-8 mt-6 px-1'>
              <Card className='bg-[#252525] border-gray-700'>
                <CardHeader className='pb-6'>
                  ...
                  <CardDescription className='text-gray-400'>
                    Manage tenant settings, features, and advanced options
                  </CardDescription>
                </CardHeader>
                      ...
                      <div className='space-y-6'>
                          ...
                          <div className='flex items-center gap-3'>
                            ...
                            <div>
                              ...
                              <div className='text-sm text-gray-300'>
                                Enable live data synchronization and updates
                              </div>
                            </div>
                          </div>
                          <Switch
                        ...
                        <div className='space-y-3'>
                          ...
                          <p className='text-sm text-gray-400'>
                            Configure a custom domain for this tenant's services
                          </p>
                        </div>
                      </div>
                          ...
                          <div className='flex items-start gap-4'>
                            ...
                            <div className='flex-1'>
                              ...
                              <div className='text-red-200 mt-1'>
                                Permanently delete this tenant and all
