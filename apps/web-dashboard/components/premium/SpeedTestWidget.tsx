...
export default function SpeedTestWidget() {
  ...
  return (
    <div
      ref={containerRef}
      className='py-16 bg-linear-to-br from-white via-cyan-50/30 to-blue-50/20'
    >
      <div className='container mx-auto px-4'>
        <div className='text-center mb-12'>
          ...
          <h2 className='text-4xl font-bold text-gray-800 mb-4'>
            Speed Test{' '}
            <span className='bg-linear-to-br from-cyan-600 to-blue-600 bg-clip-text text-transparent'>
              Widget
            </span>
          </h2>
          <p className='text-gray-600 max-w-2xl mx-auto text-lg'>
            Experience our network performance in real-time. Test your
            connection speed with our interactive speed test tool.
          </p>
        </div>
          ...
          <div className='bg-white/60 backdrop-blur-sm rounded-3xl border border-cyan-200 p-8 shadow-2xl'>
            ...
            <div className='relative mb-8'>
              <div className='w-64 h-32 mx-auto relative overflow-hidden'>
                ...
                <div className='absolute top-4 left-1/4 text-xs text-gray-500'>
                  100
                </div>
                <div className='absolute top-0 left-1/2 transform -translate-x-1/2 text-xs text-gray-500'>
                  250
                </div>
                <div className='absolute top-4 right-1/4 text-xs text-gray-500'>
                  400
                </div>
                ...
                <div className='absolute bottom-8 left-1/2 transform -translate-x-1/2'>
                  <div className='relative'>
                    <div
                      ref={speedMeterRef}
                      className='w-1 h-16 bg-linear-to-t from-red-500 to-red-600 origin-bottom transform -rotate-90 shadow-lg'
            ...
            <div className='text-center mb-8'>
              <div
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border ${getPhaseColor(currentPhase)}`}
              >
                {isRunning && (
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-8'>
              {/* Ping */}
              <div className='bg-linear-to-br from-yellow-50 to-orange-50 rounded-2xl border border-yellow-200 p-6 text-center'>
                ...
                <div className='text-green-600 text-sm mt-2'>
                  {testResults.ping > 0 && testResults.ping < 20
                    ? 'Excellent'
                    : testResults.ping >= 20 && testResults.ping < 50
                      ? 'Good'
                      : testResults.ping >= 50
                        ? 'Fair'
                        : 'Testing...'}
              ...
              {/* Download */}
              <div className='bg-linear-to-br from-blue-50 to-cyan-50 rounded-2xl border border-blue-200 p-6 text-center'>
                <div className='flex justify-center mb-3'>
                ...
                <div className='text-green-600 text-sm mt-2'>
                  {testResults.download > 100
                    ? 'Ultra Fast'
                    : testResults.download > 50
                      ? 'Fast'
                      : testResults.download > 0
                        ? 'Good'
                        : 'Testing...'}
                </div>
              </div>
              ...
              {/* Upload */}
              <div className='bg-linear-to-br from-purple-50 to-pink-50 rounded-2xl border border-purple-200 p-6 text-center'>
                <div className='flex justify-center mb-3'>
                ...
                <div className='text-green-600 text-sm mt-2'>
                  {testResults.upload > 50
                    ? 'Excellent'
                    : testResults.upload > 25
                      ? 'Good'
            ...
            {/* Server location */}
            <div className='flex items-center justify-center gap-2 mb-6 p-4 bg-linear-to-rrom-emerald-50 to-green-50 rounded-xl border border-emerald-200'>
              <MapPin className='w-5 h-5 text-emerald-600' />
              <span className='text-emerald-700 font-medium'>
                Testing from: {testResults.location}
              </span>
            </div>
              ...
              <button
                ...
                className={`px-8 py-4 rounded-xl font-medium transition-all duration-300 flex items-center gap-3 mx-auto ${
                  isRunning
                    ...
                    : 'bg-linear-to-r from-cyan-500 to-blue-600 text-white shadow-lg hover:shadow-xl hover:scale-105'
                }`}
                data-magnetic
              >
                {isRunning ? (
            ...
            <div className='mt-6 text-center text-sm text-gray-600'>
              ...
              <p className='mt-1'>
                Results may vary based on your location and network conditions
              </p>
            </div>
          </div>
        </div>
